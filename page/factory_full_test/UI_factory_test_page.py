...
class Ui_factory_test_func(object):
    def setupUi(self, factory_test_func):
        ...
        self.gBox_DevManager.setGeometry(QtCore.QRect(10, 10, 591, 591))
        font = QtGui.QFont()
        font.setFamily("Consolas")
        ...
        self.gBox_guiMesg.setGeometry(QtCore.QRect(10, 620, 1261, 211))
        font = QtGui.QFont()
        font.setFamily("Consolas")
        font.setPointSize(16)
        font.setItalic(True)
        ...
        self.tabWidget_action.setGeometry(QtCore.QRect(610, 10, 661, 591))
        font = QtGui.QFont()
        font.setFamily("Consolas")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.verticalLayoutWidget_3.setGeometry(QtCore.QRect(30, 440, 591, 100))
        ...
        self.VLayout_writeSN.addWidget(self.lineEdit_DevSN)
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(30, 10, 591, 421))
        ...
        self.progressBar_FwUpdate.setProperty("value", 24)
        ...
        self.label_showSatus.setGeometry(QtCore.QRect(310, 600, 591, 251))
