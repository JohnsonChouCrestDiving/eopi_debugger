...
class Ui_factory_test_func(object):
    def setupUi(self, factory_test_func):
        ...
        factory_test_func.resize(1250, 800)
        factory_test_func.setMinimumSize(QtCore.QSize(1250, 800))
        factory_test_func.setMaximumSize(QtCore.QSize(1250, 800))
        font = QtGui.QFont()
        ...
        self.gBox_DevManager.setGeometry(QtCore.QRect(30, 10, 591, 491))
        font = QtGui.QFont()
        font.setFamily("Consolas")
        ...
        self.gBox_DevManager.setStyleSheet("background-color: rgb(60, 60, 60);\n"
"color: rgb(230, 255, 255);")
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(10, 30, 567, 441))
        ...
        self.Btn_findWatch.setStyleSheet("background-color: rgb(175, 175, 175);\n"
"color: rgb(0, 0, 0);")
        ...
        self.HLayout_DevVolt = QtWidgets.QHBoxLayout()
        self.HLayout_DevVolt.setContentsMargins(-1, 0, -1, -1)
        self.HLayout_DevVolt.setObjectName("HLayout_DevVolt")
        self.label_BattVolt = QtWidgets.QLabel(self.verticalLayoutWidget)
        font = QtGui.QFont()
        font.setFamily("Consolas")
        font.setPointSize(14)
        font.setBold(False)
        font.setWeight(50)
        self.label_BattVolt.setFont(font)
        self.label_BattVolt.setObjectName("label_BattVolt")
        self.HLayout_DevVolt.addWidget(self.label_BattVolt)
        self.label_currentBattVolt = QtWidgets.QLabel(self.verticalLayoutWidget)
        font = QtGui.QFont()
        font.setFamily("Consolas")
        font.setPointSize(20)
        self.label_currentBattVolt.setFont(font)
        self.label_currentBattVolt.setAlignment(QtCore.Qt.AlignJustify|QtCore.Qt.AlignVCenter)
        self.label_currentBattVolt.setObjectName("label_currentBattVolt")
        self.HLayout_DevVolt.addWidget(self.label_currentBattVolt)
        self.label_mV = QtWidgets.QLabel(self.verticalLayoutWidget)
        font = QtGui.QFont()
        font.setFamily("Consolas")
        font.setPointSize(14)
        self.label_mV.setFont(font)
        self.label_mV.setObjectName("label_mV")
        self.HLayout_DevVolt.addWidget(self.label_mV)
        self.HLayout_DevVolt.setStretch(1, 5)
        self.horizontalLayout.addLayout(self.HLayout_DevVolt)
        ...
        self.VLayout_devManage.addLayout(self.HLayout_fwTime)
        ...
        self.Btn_connect.setStyleSheet("background-color: rgb(175, 175, 175);\n"
"color: rgb(0, 0, 0);")
...
"color: rgb(0, 0, 0);")
        ...
        self.Btn_scanDevice.setStyleSheet("background-color: rgb(175, 175, 175);\n"
"color: rgb(0, 0, 0);")
        ...
        self.VLayout_devManage.setStretch(5, 100)
        self.gBox_guiMesg = QtWidgets.QGroupBox(factory_test_func)
        self.gBox_guiMesg.setGeometry(QtCore.QRect(30, 520, 1191, 271))
        font = QtGui.QFont()
        font.setFamily("Consolas")
        font.setPointSize(16)
        font.setItalic(True)
        self.gBox_guiMesg.setFont(font)
        self.gBox_guiMesg.setStyleSheet("background-color: rgb(60, 60, 60);\n"
"color: rgb(230, 255, 255);")
        self.gBox_guiMesg.setObjectName("gBox_guiMesg")
        self.textBrowser_guiMessage = QtWidgets.QTextBrowser(self.gBox_guiMesg)
        self.textBrowser_guiMessage.setGeometry(QtCore.QRect(10, 30, 1171, 231))
        font = QtGui.QFont()
        font.setFamily("Consolas")
        font.setPointSize(14)
        font.setItalic(False)
        self.textBrowser_guiMessage.setFont(font)
        self.textBrowser_guiMessage.setStyleSheet("color: rgb(255, 255, 255);")
        ...
        self.tabWidget_action.setGeometry(QtCore.QRect(640, 10, 581, 491))
        font = QtGui.QFont()
        font.setFamily("Consolas")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.tabWidget_action.setStyleSheet("background-color: rgb(60, 60, 60);\n"
"color: rgb(230, 255, 255);")
        ...
        self.tab_calP.setStyleSheet("")
        self.tab_calP.setObjectName("tab_calP")
        self.verticalLayoutWidget_4 = QtWidgets.QWidget(self.tab_calP)
        self.verticalLayoutWidget_4.setGeometry(QtCore.QRect(140, 180, 280, 151))
...
"color: rgb(0, 0, 0);")
        ...
        self.Btn_COMportOpen.setStyleSheet("background-color: rgb(175, 175, 175);\n"
"color: rgb(0, 0, 0);")
        ...
        self.Btn_Calibrate.setStyleSheet("background-color: rgb(175, 175, 175);\n"
"color: rgb(0, 0, 0);")
        ...
        self.LED_comPortOk.setGeometry(QtCore.QRect(440, 210, 40, 40))
        ...
        self.verticalLayoutWidget_3.setGeometry(QtCore.QRect(20, 330, 531, 111))
        ...
        self.label_sn = QtWidgets.QLabel(self.verticalLayoutWidget_3)
        font = QtGui.QFont()
        font.setFamily("Consolas")
        font.setPointSize(20)
        font.setBold(False)
        ...
        self.HLayout_inputSN.addWidget(self.label_sn)
...
"color: rgb(0, 0, 0);")
        ...
        self.Btn_enterSN.setStyleSheet("background-color: rgb(175, 175, 175);\n"
"color: rgb(0, 0, 0);")
        self.Btn_enterSN.setObjectName("Btn_enterSN")
        self.HLayout_inputSN.addWidget(self.Btn_enterSN)
        self.HLayout_inputSN.setStretch(1, 20)
        self.HLayout_inputSN.setStretch(2, 5)
        ...
        self.Btn_LogReadout.setStyleSheet("background-color: rgb(175, 175, 175);\n"
"color: rgb(0, 0, 0);")
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(20, 10, 531, 311))
        ...
        self.Btn_devTest.setStyleSheet("background-color: rgb(175, 175, 175);\n"
"color: rgb(0, 0, 0);")
...
"color: rgb(0, 0, 0);")
        ...
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(30, 190, 511, 61))
        ...
        self.Btn_selectFile.setStyleSheet("background-color: rgb(175, 175, 175);\n"
"color: rgb(0, 0, 0);")
...
"color: rgb(0, 0, 0);")
        ...
        self.Btn_updataFw.setStyleSheet("background-color: rgb(175, 175, 175);\n"
"color: rgb(0, 0, 0);")
        ...
        self.progressBar_FwUpdate.setGeometry(QtCore.QRect(30, 260, 521, 31))
        font = QtGui.QFont()
        font.setFamily("Consolas")
        font.setPointSize(14)
        ...
        self.label_waitMovie = QtWidgets.QLabel(factory_test_func)
        self.label_waitMovie.setEnabled(True)
        self.label_waitMovie.setGeometry(QtCore.QRect(30, 10, 591, 491))
        self.label_waitMovie.setStyleSheet("background-color: rgba(255, 255, 255,0);")
        self.label_waitMovie.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.label_waitMovie.setText("")
        self.label_waitMovie.setObjectName("label_waitMovie")
    ...
    def retranslateUi(self, factory_test_func):
        ...
        self.label_BattVolt.setText(_translate("factory_test_func", "Battery Volt:"))
        self.label_currentBattVolt.setText(_translate("factory_test_func", "N/A"))
        ...
        self.gBox_guiMesg.setTitle(_translate("factory_test_func", "GUI Log Message"))
        ...
        self.label_sn.setText(_translate("factory_test_func", "SN:"))
        self.lineEdit_DevSN.setPlaceholderText(_translate("factory_test_func", "Please enter device SN..."))
        ...
        self.tabWidget_action.setTabText(self.tabWidget_action.indexOf(self.tab_writeSn), _translate("factory_test_func", "Final Test"))
